import stls from '@/styles/components/sections/JumbotronProgramDisabled.module.sass'
...
const JumbotronProgramDisabled = ({ program }) => {
	const at = useAt()
	const isDiscounted =
		(at.mini && at.online) ||
		(at.mba && at.online) ||
			...
			<div className={stls.disabled}>
				<div className={stls.description}>
					<svg
						...
						<g clip-path='url(#clip0_3431_1802)'>
							<path
...
export default JumbotronProgramDisabled
