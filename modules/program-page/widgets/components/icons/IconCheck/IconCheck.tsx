...
export const IconCheck = ({ ...rest }: SVGProps<SVGSVGElement>) => {
	return (
		<svg
			...
			{...rest}
		>
			<g clipPath='url(#clip0_254_2219)'>
				<circle cx='12.0383' cy='12.0337' r='12' fill='#FF3535' />
				<path
