...
export const GetHowProcessGoesData = () => {
	...
	return [
		...
		},
		{
			...
			description:
				'С вами на связи постоянно будут кураторы. Вы всегда сможете к ним обратиться, если у вас возникнут вопросы по процессу обучения или необходимость в обратной связи от преподавателей',
